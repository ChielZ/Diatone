                        ...
                        ZStack {
                            ...
                            ScrollView {
                                VStack(alignment: .leading, spacing: 15) {
                                    ...
                                    Text("The Pentatone is a musical instrument designed specifically for your iPhone or iPad. Whether you're picking up your first instrument or you're an experienced musician exploring new sounds and scales, Pentatone offers an immediate and expressive way to learn and make music. This guide will explain all the functions of the app, and also includes background sections on music theory and sound synthesis.")
                                        .foregroundColor(Color("KeyColour1"))
