...
struct TouchView: View {
    ...
    var body: some View {
        Group {
            ...
            // Row 3 - Initial Touch to Aux Envelope Cutoff Amount (meta-modulation)
            SliderRow(
                label: "XSTART TO FILTER ENV",
                value: Binding(
            ...
            // Row 4 - Aftertouch to Modulator Level (modulation index)
            SliderRow(
                label: "XMOVE TO MOD",
                value: Binding(
